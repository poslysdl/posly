 ...
 <!-- BEGIN PAGE -->
  <div class="page-content-wrapper">
    <div class="page-content">
     <div class="row getting-started-main alert alert-warning alert-dismissable">
        <div class="col-md-12 col-sm-12">
          <div class="portlet box blue boxshadown">
            <div class="portlet-body">
              <div class="tabbable tabs-right">
                <div class="slide-nav col-md-4">
                  <h5>Getting started</h5>
                  <ul class="nav nav-tabs">
                    <li class="active"> <a href="#tab_7_1" data-toggle="tab">Our Mission</a> </li>
                    <li class=""> <a href="#tab_7_2" data-toggle="tab">Rating Images</a> </li>
                    <li> <a href="#tab_7_3" data-toggle="tab">Upload Images</a> </li>
                    <li> <a href="#tab_7_4" data-toggle="tab">Blog</a> </li>
                    <li> <a href="#tab_7_5" data-toggle="tab">Follow & Messeages</a> </li>
                  </ul>
                  <div class="tp-bullets simplebullets round">
                    <div class="bullet active" href="#tab_7_1" data-toggle="tab"></div>
                    <div class="bullet" href="#tab_7_2" data-toggle="tab"></div>
                    <div class="bullet" href="#tab_7_3" data-toggle="tab"></div>
                    <div class="bullet" href="#tab_7_4" data-toggle="tab"></div>
                    <div class="bullet" href="#tab_7_5" data-toggle="tab"></div>
                  </div>
                </div>
                <div class="tab-content col-md-8">
                  <div class="tab-pane active" id="tab_7_1">
                    Need design this content Our Mission
   

                  </div>
                  <div class="tab-pane fade" id="tab_7_2">
                    Need design this content  Rating Images
   
                  </div>
                  <div class="tab-pane fade" id="tab_7_3">
                    Need design this content  Upload Images
   
                  </div>
                   <div class="tab-pane fade" id="tab_7_4">
                    Need design this content  Blog
                  ...
                  <div class="tab-pane fade" id="tab_7_5">
                    <div class="row-fluid">
                        ...
                        <h2>Follow</h2> 
                        <p>Follow your friends and users who you like
and see their images on a single page.</p>
<button class="btn white" type="button">Follow</button>
                        <div class="capbot">See my friends' images &gt; &gt;</div>
                        ...
                        <div class="caption-epic">
                        <h2>Messeages</h2> 
                        <p>Our Plattform enables you to contact any
User by using our awesome Chat function</p>
<button class="btn white" type="button">Message</button>
                        <div class="capbot">Find my friends from Facebook | Twitter &gt; &gt;</div>
  	...
  	foreach($photos as $p)
  	{
            ...
            <div class="portlet-title">
              <div class="caption"> <img src="<?php
                            ...
                            if($fromurl=='http' || $fromurl=='https')
                            echo $p->user->userDetails->user_details_avatar; 
                            else
                            echo Yii::app()->baseUrl.'/profiles/'.$p->user->userDetails->user_details_avatar; ?>" alt="" class="avatar-user-l img-responsive">
                <div class="cap1"> <a class="username" href="#"><?php echo $p->user->userDetails->user_details_firstname.' '.$p->user->userDetails->user_details_lastname; ?></a><span class="user-locaion"><?php if(isset($p->user->userLocation->user_location_country) && isset($p->user->userLocation->user_location_city))
                 echo $p->user->userLocation->user_location_country.', '.$p->user->userLocation->user_location_city;
                 elseif(isset($p->user->userLocation->user_location_country))
                 echo $p->user->userLocation->user_location_country; ?></span> </div>
              </div>
              <div class="rank">
            ...
            <div class="portlet-body">
              ...
              <div id="myCarousel<?php echo $i; ?>" class="carousel image-carousel slide view-first">
				...
				?>
				                  <li data-target="#myCarousel<?php echo $i; ?>" data-slide-to="0" class="active"> <img src="<?php echo Yii::app()->baseUrl; ?>/files/<?php echo $sp->user_id; ?>/thumbnail/<?php echo $sp->photos_name; ?>" class="img-responsive img-load" photo_id="<?php echo $sp->photos_id; ?>"></li>
				                  <?php 
				                  $firsttime=false; 
				                  }
				                  else
				                  {
								  	?>
                 <li data-target="#myCarousel<?php echo $i; ?>" data-slide-to="<?php echo $slidernum; ?>"> <img src="<?php echo Yii::app()->baseUrl; ?>/files/<?php echo $sp->user_id; ?>/thumbnail/<?php echo $sp->photos_name; ?>" class="img-responsive img-load" photo_id="<?php echo $sp->photos_id; ?>"> </li>
                 <?php
                 }
                 $slidernum++;
                 } ?>
