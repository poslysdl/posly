		...
		foreach($p->follow->photos as $pn)
		{
            ...
            <div class="portlet-title">
              <div class="caption"> <img src="<?php
                      		$fromurl=strstr($p->follow->userDetails->user_details_avatar, '://', true);
                            if($fromurl=='http' || $fromurl=='https')
                            echo $p->follow->userDetails->user_details_avatar; 
                            else
                            echo Yii::app()->baseUrl.'/profiles/'.$p->follow->userDetails->user_details_avatar; ?>" alt="" class="avatar-user-l img-responsive">
                <div class="cap1"><?php echo CHtml::link($p->follow->userDetails->user_details_firstname.' '.$p->follow->userDetails->user_details_lastname, array('profile/index', 'url'=>$p->follow->userDetails->user_unique_url), array('class'=>'username')); ?><span class="user-locaion"><?php if(isset($p->follow->userLocation->user_location_country) && isset($p->follow->userLocation->user_location_city))
                 echo $p->follow->userLocation->user_location_country.', '.$p->follow->userLocation->user_location_city;
                 elseif(isset($p->follow->userLocation->user_location_country))
                 echo $p->follow->userLocation->user_location_country; ?></span> </div>
              </div>
              <div class="rank">
                <h2> #<?php echo $p->follow->userDetails->user_rank_worldwide; ?> Rank </h2>
            ...
            <div class="portlet-body">
              <div class="main-img-user">
               <div id="myCarousel<?php echo $i; ?>" class="carousel image-carousel slide view-first">
                  ...
                  <?php
                  $userPhotos=Photos::model()->findAll("user_id=$p->follow_id");
                  $firsttime=true;
                  ...
                  ?>
                    <div class="active item"><a class="hover-zomm" href="#share-pic"  data-toggle="modal" > <img onclick="change_image(this,$(this).attr('dphoto_id'))" src="<?php echo Yii::app()->baseUrl; ?>/files/<?php echo $p->follow_id; ?>/medium/<?php echo $sp->photos_name; ?>" class="img-responsive img-zoom" alt="<?php echo $sp->photos_name; ?>" dphoto_id="<?php echo $sp->photos_id; ?>"></a>
                      <div class="mask">
                  ...
                  foreach($userPhotos as $sp)
                  {
                  	...
                  	{
                  	?>
                    <li data-target="#myCarousel<?php echo $i; ?>" data-slide-to="<?php echo $slidernum; ?>" class="active"> <img src="<?php echo Yii::app()->baseUrl; ?>/files/<?php echo $p->follow_id; ?>/thumbnail/<?php echo $sp->photos_name; ?>" class="img-responsive img-load" photo_id="<?php echo $sp->photos_id; ?>"></li>
                 ...
                 { ?>
                 <li data-target="#myCarousel<?php echo $i; ?>" data-slide-to="<?php echo $slidernum; ?>"> <img src="<?php echo Yii::app()->baseUrl; ?>/files/<?php echo $p->follow_id; ?>/thumbnail/<?php echo $sp->photos_name; ?>" class="img-responsive img-load" photo_id="<?php echo $sp->photos_id; ?>"> </li>
                 <?php
