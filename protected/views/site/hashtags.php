  	...
  	foreach($photos as $alltags)
  	{
            ...
            <div class="portlet-title">
              <div class="caption"> <img src="<?php
                      		$fromurl=strstr($alltags->photos->user->userDetails->user_details_avatar, '://', true);
                            if($fromurl=='http' || $fromurl=='https')
                            echo $alltags->photos->user->userDetails->user_details_avatar; 
                            else
                            echo Yii::app()->baseUrl.'/profiles/'.$alltags->photos->user->userDetails->user_details_avatar; ?>" alt="" class="avatar-user-l img-responsive">
                <div class="cap1"><?php echo CHtml::link($alltags->photos->user->userDetails->user_details_firstname.' '.$alltags->photos->user->userDetails->user_details_lastname, array('profile/index', 'url'=>$alltags->photos->user->userDetails->user_unique_url), array('class'=>'username')); ?> <span class="user-locaion"><?php if(isset($alltags->photos->user->userLocation->user_location_country) && isset($alltags->photos->user->userLocation->user_location_city))
                 echo $alltags->photos->user->userLocation->user_location_country.', '.$alltags->photos->user->userLocation->user_location_city;
                 elseif(isset($alltags->photos->user->userLocation->user_location_country))
                 echo $alltags->photos->user->userLocation->user_location_country; ?></span> </div>
              </div>
              <div class="rank">
                <h2> #<?php echo $alltags->photos->user->userDetails->user_rank_worldwide; ?> Rank </h2>
            ...
            <div class="portlet-body">
              <div class="main-img-user">
               <div id="myCarousel<?php echo $i; ?>" class="carousel image-carousel slide view-first">
                  ...
                  <?php
                  $id=$alltags->photos->user->user_id;
                  ...
                  ?>
                    <div class="active item"><a class="hover-zomm" href="#share-pic"  data-toggle="modal" > <img onclick="change_image(this,$(this).attr('dphoto_id'))" src="<?php echo Yii::app()->baseUrl; ?>/files/<?php echo $alltags->photos->user->user_id; ?>/medium/<?php echo $sp->photos_name; ?>" class="img-responsive img-zoom" alt="<?php echo $sp->photos_name; ?>" dphoto_id="<?php echo $sp->photos_id; ?>"></a>
                      <div class="mask">
                  ...
                  foreach($userPhotos as $sp)
                  {
                  	...
                  	{
                  	?>
                    <li data-target="#myCarousel<?php echo $i; ?>" data-slide-to="<?php echo $slidernum; ?>" class="active"> <img src="<?php echo Yii::app()->baseUrl; ?>/files/<?php echo $alltags->photos->user->user_id; ?>/thumbnail/<?php echo $sp->photos_name; ?>" class="img-responsive img-load" photo_id="<?php echo $sp->photos_id; ?>"></li>
                 ...
                 { ?>
                 <li data-target="#myCarousel<?php echo $i; ?>" data-slide-to="<?php echo $slidernum; ?>"> <img src="<?php echo Yii::app()->baseUrl; ?>/files/<?php echo $alltags->photos->user->user_id; ?>/thumbnail/<?php echo $sp->photos_name; ?>" class="img-responsive img-load" photo_id="<?php echo $sp->photos_id; ?>"> </li>
                 <?php
