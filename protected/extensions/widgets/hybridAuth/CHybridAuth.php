...
class CHybridAuth extends CApplicationComponent {
    ...
    public function postImg($provider,$pdata){
        try{
            return $this->getAdapter($provider)->postImagefb($pdata);
        }catch(Exception $e){
            $this->_errorMessage($e);
        }
    }
    
    public function sendInvite($provider, $ids){
        try{
            return $this->getAdapter($provider)->sendInvitation($ids);
        }catch(Exception $e){
            $this->_errorMessage($e);
        }
    }
