        ...
        <li class="panel-tag">
          <div>
            <div class="panel">
              ...
              <div class="side-tag">
                <div class="tagcloud"> <a href="#">Gucci</a> <a href="#">Louis Vuitton</a> <a href="#l">Love</a> <a href="#">MC</a> <a href="#">Prada  Maksita</a></div>
              </div>
            </div>
          </div>
        </li>
            ...
            <div class="panel">
              ...
              <div class="scrollercm" style="height: 275px;" data-always-visible="0" data-rail-visible1="0">
                <ul class="notifi-panel">
                  <li class="noti-area"> <img class="avatar img-responsive" alt="" src="assets/img/avatar1.jpg" />
                    <div class="message"> <span class="name">Chanh Ny</span> likes Chi Minh Anh's photo. </div>
                  </li>
                  <li class="noti-area"> <img class="avatar img-responsive" alt="" src="assets/img/avatar2.jpg" />
                    <div class="message"> <span class="name"> Son Vu Truong</span> signed a player on Top Eleven Be a Football Manager.</div>
                  </li>
                  <li class="noti-area"> <img class="avatar img-responsive" alt="" src="assets/img/avatar3.jpg" />
          ...
          <div>
            <div class="panel">
              ...
              <div class="scrollercm" style="height: 210px;" data-always-visible="0" data-rail-visible1="0">
                <ul class="feeds-chat">
                  <li>
                    <div class="col1"> <img class="avatar img-responsive" alt="" src="assets/img/avatar1.jpg" />
                  ...
                  <li>
                    <div class="col1"> <img class="avatar img-responsive" alt="" src="assets/img/avatar2.jpg" />
                  ...
                  <li>
                    <div class="col1"> <img class="avatar img-responsive" alt="" src="assets/img/avatar3.jpg" />
